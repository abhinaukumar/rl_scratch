...
class ActorCritic(nn.Module):
    def __init__(self,input_dim,dims,n_actions):
        ...
        self.action_layer = nn.Linear(dims,n_actions+1)
...
class Agent():
    def __init__(self,env):
        ...
        self.n_actions = 10
        self.model = ActorCritic(self.n_options,25,self.n_options).to(devices[self.eps_env])
...
def train(args): 
    ...
    for i in range(100):
        ...
        while env.iters < 1000:
            length+=1
            choice = agent.act(evidence,greedy=True)
        ...
        if not i%10:
            ...
            print "{}, {}, {}".format(correct/10.0,length/1000.0,tot_reward/1000.0)
